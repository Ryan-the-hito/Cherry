...
from PyQt6.QtWidgets import (QWidget, QPushButton, QApplication,
                             ...
                             QSystemTrayIcon, QMenu, QDialog, QGraphicsOpacityEffect)
...
action3 = QAction("🔊 Manage my volume!")
...
class window_about(QWidget):  # 增加说明页面(About)
    ...
    def setUpMainWindow(self):
        widg1 = QWidget()
        l1 = QLabel(self)
        png = PyQt6.QtGui.QPixmap('Cherry.png')  # 调用QtGui.QPixmap方法，打开一个图片，存放在变量png中
    ...
    def homepage(self):
        webbrowser.open('https://github.com/Ryan-the-hito/Paprika')
    ...
    def startcherry(self):
        cmd = """osascript -e '''
        tell application "Terminal"
            activate
        	do script "/Applications/Cherry.app/Contents/Preferences/Cherry.app/Contents/MacOS/Cherry ; exit;"
        end tell'''"""
        os.system(cmd)